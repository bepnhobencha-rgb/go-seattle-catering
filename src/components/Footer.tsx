    ...
    <footer className="mt-24 border-t border-gold-900/40 bg-ink-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="mt-6 text-cream/60 text-sm max-w-md">
            From intimate gatherings to unforgettable weddings, we bring the taste of Vietnam
            to your table with love and care.
          </p>
        </div>

        <div>
          <h4 className="text-gold-300 text-sm font-bold tracking-widest uppercase mb-4">Visit</h4>
        ...
        <div>
          <h4 className="text-gold-300 text-sm font-bold tracking-widest uppercase mb-4">Hours</h4>
      ...
      <div className="border-t border-gold-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-cream/50">
          ...
          <div className="flex gap-4">
            <Link href="/menu" className="hover:text-gold-300">Menu</Link>
            <Link href="/catering" className="hover:text-gold-300">Catering</Link>
            <Link href="/account" className="hover:text-gold-300">Account</Link>
          </div>
        </div>
      </div>
    </footer>
